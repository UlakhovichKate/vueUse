...
<template>
  ...
  <div v-if="revaled1">
    <div>
      ...
      <footer>
        <button @click="dialog1.confirm" class="btn btn-outline-success">
          OK
        </button>
        <button @click="dialog1.cancel" class="btn btn-outline-danger">
          Cancel
        </button>
      </footer>
    </div>
  ...
  <div v-if="revaled2">
    <div>
      ...
      <footer>
        <button @click="dialog2.confirm(true)" class="btn btn-outline-success">
          Confirm
        </button>
        <button @click="dialog2.confirm(false)" class="btn btn-outline-info">
          Reject
        </button>
        <button @click="dialog2.cancel" class="btn btn-outline-danger">
          Cancel
        </button>
      </footer>
    </div>
